...
class ReminderNavigationScreen
    extends StatefulWidget {
  const ReminderNavigationScreen({Key? key})
      : super(key: key);

  @override
  State<ReminderNavigationScreen>
      createState() =>
          _ReminderNavigationScreenState();
}

class _ReminderNavigationScreenState
    extends State<
