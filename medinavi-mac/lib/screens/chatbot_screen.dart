...
class _ChatbotScreenState
  ...
  final List<String> _apiKeys = [
    "AIzaSyAYD5E4hRtEJQBtb805mXxopU9Jh3iICAQ",
    "AIzaSyAItp_BZMcSFcMsXzokyF6oQmytESx7byY",
    "AIzaSyCMGewGDIke0T_C6Gnr4lkjrQeUGxtYUEI",
    "AIzaSyCnhTPpWN2LgK_cGiqgxcgKmaEWYqVsB7w",
    "AIzaSyD37KZLa-RyKzAneIFGMi3WCqjqN4cFuQg",
    "AIzaSyDZcS6Xw3mSV_yfmFF0PMlhsUUfXnTd4qg",
    ...
    "AIzaSyDhBKRVMmZXsyQ5gUMiaXvXx3zxgo1SPTM",
    "AIzaSyC6mOx8tdzrSaulzzc3GAfR-7tsiPhjcJ4",
    "AIzaSyAGN_2Uq5zhdvhZipKJGlOvpfcPJkmqTZI"
  ];
  ...
  Future<void>
    ...
    final confirmed =
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Start a new conversation? Current chat will be saved and you can access it later.',
        ),
        actions: [
          TextButton(
            onPressed: () =>
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          // UPDATED: Delete button (replaces refresh)
          IconButton(
            icon: const Icon(
                Icons
