...
class _MapScreenState
  ...
  void _centerOnService() {
    _mapController.move(
      LatLng(widget.service.latitude,
  ...
  Future<void> _getDirections() async {
    ...
    print(
        '🚗 Getting directions for mode: $_selectedTravelMode');
    print(
        '📍 From: ${widget.currentPosition.latitude}, ${widget.currentPosition.longitude}');
    print(
        '📍 To: ${widget.service.latitude}, ${widget.service.longitude}');
    ...
    if (directions != null &&
        ...
        directions['routes']
            .isNotEmpty) {
      print(
          '✅ Valid route found, decoding polyline...');
      ...
      try {
        ...
        print(
            '✅ Decoded ${decodedPoints.length} points');
        ...
        print(
            '✅ Route displayed successfully');
      } catch (e) {
        print(
            '❌ Error decoding polyline: $e');
        if (mounted) {
        ...
        if (directions != null &&
          ...
          switch (status) {
            ...
            case 'INVALID_REQUEST':
              errorMessage =
                  'Invalid request: ${apiError ?? 'Unknown error'}';
              errorColor = Colors.red;
              break;
                    ...
                    children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: widget.service.isOpen ? Colors.green.withOpacity(0.1) : Colors.red.withOpacity(0.1),
                                        borderRadius: BorderRadius.circular(4),
                                      ),
                                      child: Text(
                                        widget.service.isOpen ? AppLocalizations.of(context)!.openNow : AppLocalizations.of(context)!.closed,
                                        style: TextStyle(
                                          fontSize: 12,
                                          fontWeight: FontWeight.w600,
                                          color: widget.service.isOpen ? Colors.green[700] : Colors.red[700],
                                        ),
                                      ),
                                    ),
                                  ],
                      ...
                      Row(
                        children: [
                          ...
                          Flexible(
                            child: Text(
                              AppLocalizations.of(context)!.away(widget
                                  .service
                                  .distance
                                  .toStringAsFixed(
                                      1)),
                          ...
                          if (_directionsData !=
                            ...
                            Flexible(
                              child:
                                  Text(
                                _directionsData!['routes'][0]['legs'][0]['duration']
                                    [
                                    'text'],
                                style:
                                    TextStyle(
                              ...
                              Expanded(
                                child:
                                  ...
                                  onTap:
                                      () async {
                                    final url =
                                        Uri.parse(_placeDetails!['website']);
                            ...
                            if (await canLaunchUrl(
                              ...
                              if (mounted) {
                                ScaffoldMessenger.of(context)
                                  ...
                                  SnackBar(
                                    content:
                                        Text(AppLocalizations.of(context)!.errorOpeningMaps),
                                    backgroundColor:
                                        Colors.red,
                                  ),
                                );
